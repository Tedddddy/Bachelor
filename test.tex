...
\subsection{Adapting the key ideas}
    ...
    \begin{remark}
        ...
        This can be shown by a counterexample. We will only do it for $D$ because for $D4$ it's done similar. Assume $F_1 = N_\omega(T_{\omega[rn]})_1 = (X, \tau_1)$ and $F_2 = N_\omega(T_{\omega[rn]})_2 = (Y, \tau_2)$.
