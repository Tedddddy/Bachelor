...
\begin{lemma}
    ...
    \begin{proof}
            ...
            For the other direction, we pick $\vec{a} \in R(f_F(x))$. We have to find $\beta \in U_m(x)$ s.t $f_F(\beta) = \vec{a}$. We assume R is irreflexiv and non-transitive.
...
\begin{proposition}
    ...
    \begin{proof}
        ...
        Hence, $X,x \not\vDash \Box\Box p$. But thats a contradiction.
