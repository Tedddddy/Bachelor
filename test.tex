...
\begin{definition}
    ...
    (examples : $2_{1}, 4231123_{1}$).
    $\mathbb{N}^+_{1}$ is the set $\mathbb{N}_{1}$*- \{$\epsilon$\}. $\mathbb{N}$, $\mathbb{N}^+_{2}$ are defined similar. \newline \newline
    Now let $T_{\omega,\omega,\omega [in]} = (W, R, R_1, R_2 )$ where $W = (\mathbb{N}_{R} \cup \mathbb{N}_{1} \cup \mathbb{N}_{2})^+ \cup \{ \epsilon\}$, 
