...
such as Filtration Theorem and Sahlqvist Theorem which play a role in our later chapters. The content is mainly based on the Modal Logic book [7].
...
\begin{proposition}
    ...
    \begin{proof}
        ...
        By that fact, we can follow with Remark 2.1.3, that $f^{-1}(B_t)$ is open and hence $f$ is continuous.
