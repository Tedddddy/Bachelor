...
\end{figure}
    ...
    We denote $\tau_1$ is the set of all H-open subsets of $X \times Y$ and $\tau_2$ is the set of all V-open subsets of $X\times Y$. We say $\tau$ is the set of all standard product of subsets $X \times Y$ s.t. $X \in \chi$ and $Y \in \upsilon$.
...
that there exists a 3-topo-bisimulation between $T_{6,2,2}$ and $X \times X$ = $X'$ where each $X$ is as defined in Theorem 5.0.3. 
