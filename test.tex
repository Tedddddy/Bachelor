...
\begin{tikzpicture}
   \node (A) at (0,0) [circle, draw, minimum height=17pt, inner sep=0pt] {$\epsilon$};
    ...
    \node (E) at (-3.5,-3.5) [circle,draw,minimum size = 17pt, inner sep = 1pt] {11};
    \node (F) at (-2.5,-3.5) [circle,draw,minimum size = 17pt, inner sep = 1pt] {12};
  ...
  \node (I) at (1.5,-3.5) [circle,draw,minimum size=10pt,inner sep=0pt] {$11_{\mathbb{N}_2}$};
  \node (J) at (2.5,-3.5) [circle,draw,minimum size=10pt,inner sep=0pt] {$12_{\mathbb{N}_2}$};
  ...
  \node (M) at (-6,-3.5) [circle,draw,minimum size=17pt,inner sep=0pt] {$11_{\mathbb{N}_1}$};
  ...
  \draw (-2.2,-2.2) -- (-3.4,-3.15);
  \draw (-2.2,-2.2) -- (-2.4, -3.15);

  \draw [dotted] (-0.03, -0.3) -- (2, -1.7);
  \draw[dotted] (-0.03, -0.3) -- (3, -1.7);
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \draw [dotted] (2, -2.3) -- (1.5, -3.1);
  \draw [dotted] (2, -2.3) -- (2.5, -3.1);
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \fill (3.1,-3.5) circle (0.7pt); 
  \fill (3.3,-3.5) circle (0.7pt); 
  \fill (3.5,-3.5) circle (0.7pt); 
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \fill (-3.0,-4) circle (0.7pt); 
  \fill (-3,-4.2) circle (0.7pt); 
  \fill (-3,-4.4) circle (0.7pt); 
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \fill (2.0,-4) circle (0.7pt); 
  \fill (2,-4.2) circle (0.7pt); 
  \fill (2,-4.4) circle (0.7pt); 
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \draw [dotted] (-0.03, -0.3) -- (-4.5, -1.75);
  \draw[dotted] (-0.03, -0.3) -- (-5.5, -1.75);
  \draw[dotted] (-5.5, -2.3) -- (-6, -3.1);
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \fill (-3.8,-2) circle (0.7pt); 
  \fill (-3.6,-2) circle (0.7pt); 
  \fill (-3.4,-2) circle (0.7pt); 
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \fill (-5.3,-3.5) circle (0.7pt); 
  \fill (-5.1,-3.5) circle (0.7pt); 
  \fill (-4.9,-3.5) circle (0.7pt); 
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \fill (-6,-4.05) circle (0.7pt); 
  \fill (-6,-4.25) circle (0.7pt); 
  \fill (-6,-4.45) circle (0.7pt); 
\end{tikzpicture}
\caption{This is $T_{\omega,\omega,\omega[rn]}$. The dotted lines on the left are from $R_1$ and in the right $R_2$. The whole tree is $R$.}
\end{figure}
