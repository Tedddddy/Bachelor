...
\begin{definition}
    ...
    1. $\emptyset \notin \tau(x)$ \newline
    2. $\forall U \in \tau(x) : x \in U$ \newline
    3. $\mbox{If }U \in \tau(x)$ and $U \subseteq V$ then $V \in \tau(x)$ (upward closed) \newline
    4. $\mbox{If }U, V \in \tau(x)$, then $U \cap V \in \tau(x)$
\end{definition}
...
We will use it later, to show $L_1 \times_n L_2 = L_1 \otimes L_2$.
