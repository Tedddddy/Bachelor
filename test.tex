...
For our main question, we consider the neighborhood product additionally with the standard neighborhood product. We will answer whether 
...
can be characterized as the logic of a product of neighbourhood frames but without standard neighborhood product. In this work, we start with a brief recap of necessary notation and theorems in Kripke semantics and then introduce toplogical spaces and neighborhood frames. 
...
\newline
Oftentimes, it is in theoretical and practical interest to combine topological spaces or neighborhood frames.  
...
In this chapter, we introduce the notation for product of topological spaces and the semantics for multimodal logic in topology. We will also do it for neighborhood frames.
